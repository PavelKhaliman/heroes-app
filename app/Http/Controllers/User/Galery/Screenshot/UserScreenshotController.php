...
namespace App\Http\Controllers\User\Galery\Screenshot;
...
class UserScreenshotController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('gallery.screenshot.index', compact('photos'));
    }

    public function create(): View
    {
        return view('gallery.screenshot.create');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('gallery.screenshot.index');
    }
    ...
    public function show(Photo $photo): View
    {
        ...
        $photo->load('user');
        return view('gallery.screenshot.show', compact('photo'));
    }
    ...
    public function edit(Photo $photo): View
    {
        ...
        return view('gallery.screenshot.edit', compact('photo'));
    }
    ...
    public function update(Request $request, Photo $photo): RedirectResponse
    {
        ...
        return redirect()->route('gallery.screenshot.show', $photo);
    }
