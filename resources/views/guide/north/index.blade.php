    ...
    <div class="welcome-section">
        <div class="welcome-content">
            <div class="flex items-center justify-between mb-6">
                <h1 class="welcome-title">Север</h1>
                <a href="{{ route('guide.north.create') }}" class="inline-block welcome-title text-white hover:text-white/80 transition-colors" style="font-size: 1rem; line-height: 1.5;">Добавить</a>
            </div>
            ...
            @else
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach($guides as $g)
                        <a href="{{ route('guide.north.show', $g) }}" class="block group bg-white/5 rounded-lg overflow-hidden hover:bg-white/10 transition-colors">
