...
@section('title', 'Гайды - Редактировать (Север)')
...
<div class="clan-overview grid grid-cols-1 md:grid-cols-[240px_minmax(0,1fr)] gap-6">
    ...
    <div class="welcome-section">
        <div class="welcome-content">
            ...
            <form action="{{ route('guide.north.update', $guide) }}" method="POST" enctype="multipart/form-data" class="max-w-2xl text-left">
                @csrf
                @method('PUT')
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('guide.north.show', $guide) }}" class="welcome-title text-white hover:text-white/80 transition-colors" style="font-size: 1rem; line-height: 1.5;">Отмена</a>
                </div>
            </form>
        </div>
    </div>
