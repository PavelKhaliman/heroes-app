...
@section('title', 'Гайды - Редактировать (Запад)')
...
<div class="clan-overview">
    <div class="welcome-section">
        <div class="welcome-content">
            ...
            <form action="{{ route('guide.west.update', $guide) }}" method="POST" enctype="multipart/form-data" class="max-w-2xl text-left">
                @csrf
                @method('PUT')
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('guide.west.show', $guide) }}" class="welcome-title text-white hover:text-white/80 transition-colors" style="font-size: 1rem; line-height: 1.5;">Отмена</a>
                </div>
            </form>
        </div>
    </div>
